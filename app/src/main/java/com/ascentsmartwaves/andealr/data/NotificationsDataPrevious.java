 ...
 */
public class NotificationsDataPrevious {

    String dealId,dealTittle,startDate,startTime,endDate,endTime,dealStatus;
    int likesCounter,redeemCounter;

    public NotificationsDataPrevious(String dealId, String dealTittle, String startDate, String startTime, String endDate, String endTime, String dealStatus, int likesCounter, int redeemCounter) {
        this.dealId = dealId;
