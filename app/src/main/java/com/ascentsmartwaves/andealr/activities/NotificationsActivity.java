...
import com.ascentsmartwaves.andealr.adapters.NotificationsPagerAdapter;
import com.ascentsmartwaves.andealr.fragments.MessagesFragment;
...
//        });
    ...
    private void intialiseViewPager(View v) {
        ...
        fragments.add(Fragment.instantiate(v.getContext(), com.ascentsmartwaves.andealr.fragments.NotificationsFragment.class.getName()));
    ...
    private void initialiseTabHost(Bundle args,View v) {
        ...
        NotificationsActivity.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Notifications").setIndicator("Notifications"), (tabInfo = new TabInfo("Tab1", com.ascentsmartwaves.andealr.fragments.NotificationsFragment.class, args)),v);
